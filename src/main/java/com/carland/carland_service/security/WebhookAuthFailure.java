...
/**
 * tr: Webhook kimlik doğrulamasının başarısızlık sebeplerini (eksik/geçersiz internal token, partner
 *     bulunamadı, imza hatası vb.) hata kodu ve açıklama mesajıyla birlikte tanımlayan enum'dur.
 * en: Enum defining webhook authentication failure reasons (missing/invalid internal token, partner
 *     not found, signature errors etc.) together with an error code and descriptive message.
 */
@Getter
