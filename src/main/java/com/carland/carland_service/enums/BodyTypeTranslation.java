...
/**
 * tr: Araç kasa tipi adlarının İngilizce/Azerice/Rusça çevirilerini tutan ve Accept-Language'a göre çeviri yapan enum.
 * en: Enum holding English/Azerbaijani/Russian translations of car body type names, translating based on Accept-Language.
 */
@Getter
@AllArgsConstructor
